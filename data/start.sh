...
# Application
APP_NAME="openthinclient"
APP_LONG_NAME="openthinclient.org 2.0 consus"
...
# description: openthinclient.org 2.0
 
# Initialization block for the install_initd and remove_initd scripts used by
#  SUSE linux distributions.
### BEGIN INIT INFO
# Provides: openthinclient
# Required-Start: $local_fs $network $syslog
# Should-Start: 
# Required-Stop:
# Default-Start: 2 3 4 5
# Default-Stop: 0 1 6
# Short-Description: openthinclient.org
# Description: openthinclient.org 2.0
### END INIT INFO
...
then
    ...
    then
        ...
        then
            ...
            outputFile "$WRAPPER_CMD-$DIST_OS-$DIST_ARCH"
            outputFile "$WRAPPER_CMD-$DIST_OS-$DIST_ARCH"
